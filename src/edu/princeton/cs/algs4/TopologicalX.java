 ...
 * <em>E</em> is the number of edges. Afterwards, the <em>hasOrder</em> and
 * <em>rank</em> operations takes constant time; the <em>order</em> operation
 * takes time proportional to <em>V</em>.
 * <p>
...
public class TopologicalX {
     ...
     * digraph has a topological order (or equivalently, if the digraph is a
     * DAG), and {@code null} otherwise
     */
     ...
     * equivalently, if the digraph is a DAG), and {@code false} otherwise
     */

 ...
 * class finds either a shortest path from the source vertex <em>s</em>
 ...
 * is the number of edges. Afterwards, the
 * {@code distTo()}, {@code hasPathTo()}, and {@code hasNegativeCycle()} methods
 * take constant time; the {@code pathTo()} and {@code negativeCycle()} method

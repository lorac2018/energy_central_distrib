 ...
 * <a href = "http://algs4.cs.princeton.edu/99scientific/GaussianEliminationLite.java.html">GaussianEliminationLite.java</a>
...
public class GaussianElimination {
     ...
     * <em>A</em> is an <em>m</em>-by-<em>n</em> matrix and <em>b</em>
     ...
     * @throws IllegalArgumentException if the dimensions disagree, i.e., the
     * length of {@code b} does not equal {@code m}
     */

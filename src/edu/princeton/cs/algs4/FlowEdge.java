...
public class FlowEdge {
    ...
    private double distance;           //our weight to use dijkstra
     ...
     */
    public FlowEdge(int v, int w, double capacity, double distance) {
        this.v = v;
        this.w = w;
     ...
     */
    public FlowEdge(int v, int w, double capacity, double flow, double distance) {
        if (v < 0) {
            throw new IllegalArgumentException("vertex index must be a non-negative integer");
        }
        if (w < 0) {
     ...
     * vertex If {@code vertex} is the tail vertex, the residual capacity equals
     ...
     * @throws IllegalArgumentException if {@code vertex} is not one of the
     * endpoints of the edge
     * @throws IllegalArgumentException if {@code delta} makes the flow on on
     * the edge either negative or larger than its capacity

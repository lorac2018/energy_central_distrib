 ...
 * modifiers, and other features in industrial-strength implementations such as
 ...
 * takes time proportional to <em>m</em>, where <em>m</em>
 * is the number of characters in the regular expression. The
 * <em>recognizes</em> method takes time proportional to <em>m n</em>, where
 * <em>n</em> is the number of characters in the text.
 * <p>
 * For additional documentation, see
 * <a href="http://algs4.cs.princeton.edu/54regexp">Section 5.4</a> of

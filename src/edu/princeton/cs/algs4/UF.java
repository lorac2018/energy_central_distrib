 ...
 * and components are identified with integers between 0 and
 * <em>n</em>–1. Initially, there are <em>n</em> components, with each site in
 * its own component. The <em>component identifier</em> of a component (also
 * known as the <em>root</em>, <em>canonical element</em>, <em>leader</em>, or
 ...
 * itself changes during a call to
 * <em>union</em>—it cannot change during a call to <em>find</em>,
 ...
 * <em>count</em> operation takes constant time. Moreover, the amortized time
 * per <em>union</em>, <em>find</em>, and <em>connected</em> operation has
 * inverse Ackermann complexity. For alternate implementations of the same API,
 * see {@link QuickUnionUF}, {@link QuickFindUF}, and

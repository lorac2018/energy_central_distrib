 ...
 * <em>V</em> is the number of vertices. Afterwards, the
 * {@code dist()}, {@code hasPath()}, and {@code hasNegativeCycle()} methods
 * take constant time; the {@code path()} and {@code negativeCycle()} method

 ...
 * <em>contains</em>, and <em>delete</em>
 * methods. It also provides character-based methods for finding the string in
 * the set that is the <em>longest prefix</em> of a given prefix, finding all
 * strings in the set that <em>start with</em> a given prefix, and finding all
 * strings in the set that <em>match</em> a given pattern.
 * <p>
 * This implementation uses a 256-way trie. The <em>add</em>, <em>contains</em>,
 * <em>delete</em>, and
 * <em>longest prefix</em> methods take time proportional to the length of the
 * key (in the worst case). Construction takes constant time.
 * <p>

 ...
 * <a href="http://algs4.cs.princeton.edu/51radix">Section 5.1</a> of
...
public class MSD {
    ...
    private static void sort(int[] a, int lo, int hi, int d, int[] aux) {
        ...
        /**
         * *********** BUGGGY CODE. // for most significant byte, 0x80-0xFF
         * comes before 0x00-0x7F if (d == 0) { int shift1 = count[R] -
         * count[R/2]; int shift2 = count[R/2]; for (int r = 0; r < R/2; r++)
         * count[r] += shift1; for (int r = R/2; r < R; r++) count[r] -= shift2;
         * }
***********************************
         */
        // distribute

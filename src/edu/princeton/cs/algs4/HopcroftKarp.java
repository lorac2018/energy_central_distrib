 ...
 * <em>minimum vertex cover</em>
 * is a vertex cover with the minimum number of vertices. By Konig's theorem, in
 * any biparite graph, the maximum number of edges in matching equals the
 * minimum number of vertices in a vertex cover. The maximum matching problem in
 * <em>nonbipartite</em> graphs is also important, but all known algorithms for
 * this more general problem are substantially more complicated.
 * <p>
 ...
 * V</em>) time using the <em>alternating path algorithm</em>
 * and

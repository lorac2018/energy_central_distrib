 ...
 * constructor takes time proportional to <em>V</em> + <em>E</em>
 * (in the worst case), where <em>V</em> is the number of vertices and
 * <em>E</em> is the number of edges. Afterwards, the <em>isBipartite</em> and
 * <em>color</em> operations take constant time; the <em>oddCycle</em> operation
 * takes time proportional to the length of the cycle. See {@link Bipartite} for
 * a recursive version that uses depth-first search.
 * <p>
...
public class BipartiteX {
     ...
     * vertices are in the same side of the bipartition if and only if they have
     * the same color

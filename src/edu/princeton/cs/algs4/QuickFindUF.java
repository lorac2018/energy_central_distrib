 ...
 * <em>connected</em>, and <em>count</em>
 * operations take constant time but the <em>union</em> operation takes linear
 * time. For alternate implementations of the same API, see

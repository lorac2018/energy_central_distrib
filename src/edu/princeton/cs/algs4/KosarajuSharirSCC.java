 ...
 * time proportional to <em>V</em> + <em>E</em>
 * (in the worst case), where <em>V</em> is the number of vertices and
 * <em>E</em> is the number of edges. Afterwards, the <em>id</em>,
 * <em>count</em>, and <em>areStronglyConnected</em>
 * operations take constant time. For alternate implementations of the same API,
 * see {@link TarjanSCC} and {@link GabowSCC}.
 * <p>

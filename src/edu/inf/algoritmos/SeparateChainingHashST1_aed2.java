 ...
 * @author Kevin Wayne
 */
public class SeparateChainingHashST1_aed2<Key, Value> {
     ...
     */
    public SeparateChainingHashST1_aed2() {
        this(INIT_CAPACITY);
    }
     ...
     */
    public SeparateChainingHashST1_aed2(int m) {
        this.m = m;
    ...
    private void resize(int chains) {
        SeparateChainingHashST1_aed2<Key, Value> temp = new SeparateChainingHashST1_aed2<Key, Value>(chains);
        for (int i = 0; i < m; i++) {
    ...
    public static void main(String[] args) {
        SeparateChainingHashST1_aed2<String, Integer> st = new SeparateChainingHashST1_aed2<String, Integer>();
    ...
    public String toString() {
        ...
        String str = "Tabela de hash (separate chaining) M =" + m + "n";
        //pecorrer o vetor com o tamanho M. pecorre todos os elementos que existem na sua lista.
        for (int i = 0; i < m; i++) {
